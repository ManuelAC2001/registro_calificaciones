...
public class BoletaInterna {
    ...
    private static List<CalificacionH> calificacionesBoleta;
    private static List<MesH> meses = new MesDAOH().listar();
    ...
    public static void generarPDF(File file, List<CalificacionH> calificacionesBoleta) {
        ...
        try {
            ...
            agregarInformacioPersonal();

            // Modificaciion del DOM para materias academicas
            agregarMateriasAcademicas();
            ...
            agregarPromedioTrimestralomplementaria();
    ...
    private static void agregarInformacioPersonal() {
        ...
        List<AlumnoH> alumnosLista = new AlumnoDAOH()
                .listar()
                .stream()
                .filter(a -> a.getAula().equals(alumno.getAula()))
    ...
    private static void agregarMateriasAcademicas() {
    ...
    private static void agregarMateriasComplementarias() {
        ...
        List<AsignaturaH> asignaturasComplementarias = alumno
                .getAula()
                .getGrado()
                .getAsignaturas()
                .stream()
                .filter(c -> c.getTipoAsignatura().getNombre().equals("complementaria"))
                .collect(Collectors.toList());
    ...
    private static void agregarCalificacionesAcademicasMensual(String mesNombre, String tbodyName) {
        ...
        if (calificacionesMensuales.isEmpty()) {
        ...
        Integer numeroMaterias = calificacionesMensuales.size();
        Double promedio = 0.0;

        for (CalificacionH c : calificacionesMensuales) {
            Element trCalificacion = documentHTML.createElement("tr");
    ...
    private static void agregarCalificacionesComplementariasMensual(String mesNombre, String tbodyName) {
    ...
    private static void agregarPromedioTrimestralAcademico() {
        ...
        for (AsignaturaH m : materias) {
            ...
            Element tbodyTrimestre = documentHTML.getElementById("tbody__trimestre");
            Element trTrimestre = documentHTML.createElement("tr");
    ...
    private static Boolean trimestreCalificado(List<CalificacionH> calificacionesBoleta, String nombrePeriodo) {
        ...
        Integer numeroCalificacionesByPeriodo = calificacionesBoleta.stream().filter(c -> {
            return c.getMes().getPeriodo().getNombre().equals(nombrePeriodo);
        })
                .collect(Collectors.toList())
                .size();
    ...
    private static void agregarPromedioTrimestralomplementaria() {
        ...
        for (AsignaturaH m : materias) {
            ...
            Element tbodyTrimestre = documentHTML.getElementById("tbody__trimestre_complementaria");
            Element trTrimestre = documentHTML.createElement("tr");
